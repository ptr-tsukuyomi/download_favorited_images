...
Public Class OAuth
    ...
    Public Shared Function GetHMACSHA1Signature(ByVal key As String, ByVal src As String) As String
        Dim mp = MacAlgorithmProvider.OpenAlgorithm(MacAlgorithmNames.HmacSha1)
        Dim bufkey = CryptographicBuffer.ConvertStringToBinary(key, BinaryStringEncoding.Utf8)
        Dim bufsrc = CryptographicBuffer.ConvertStringToBinary(src, BinaryStringEncoding.Utf8)
        Dim bufhmac = CryptographicEngine.Sign(mp.CreateKey(bufkey), bufsrc)

        Return CryptographicBuffer.EncodeToBase64String(bufhmac)
    End Function
